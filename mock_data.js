...
const restaurants = [
  // --- Downtown SB ---
  {
    ...
    menuItems: [
      { name: "The Big Arnoldi", description: "A half-pound certified Angus beef patty seared on a flat-top griddle until a deep golden crust forms, then layered with two slices of aged sharp cheddar that melt into every crevice of the meat. Nestled on a buttery brioche bun with crisp butter lettuce, vine-ripened tomato, thinly sliced red onion, house-made garlic aioli, and a tangy bread-and-butter pickle spear on the side." },
    ],
  },
  {
    name: "Downtown Eats",
  ...
  },
  {
    ...
    menuItems: [
      { name: "The Greek Smash", description: "A juicy quarter-pound beef patty grilled over open flame with crumbled feta and a thick slice of provolone melted on top, finished with roasted red peppers, shaved cucumber, and a drizzle of tzatziki. Served on a warm sesame-crusted bun with a handful of peppery arugula, sliced Kalamata olives, and a squeeze of fresh lemon that brightens every single bite." },
    ],
  },
  {
    name: "Eureka!",
  ...
  },
  {
    ...
    menuItems: [
      { name: "The Hotel Burger", description: "A premium eight-ounce dry-aged beef patty charbroiled to a perfect medium-rare and topped with a generous portion of melted brie and white cheddar that oozes down the sides. Served on a house-baked challah bun with arugula, heirloom tomato, caramelized shallots, truffle aioli, and a cornichon relish that adds a bright, tangy crunch to every luxurious bite." },
    ],
  },
  {
    ...
    menuItems: [
      { name: "Market Fresh Burger", description: "A hand-pressed patty of locally sourced beef grilled over mesquite charcoal, topped with a thick slab of smoked gouda and a slice of sharp white cheddar that meld together as they melt. Piled on a fresh-baked ciabatta roll with mixed baby greens, roasted garlic cloves, sun-dried tomato spread, and paper-thin rings of sweet Vidalia onion for a satisfying farmers-market-inspired cheeseburger." },
    ],
  },
  {
    name: "Gala",
    ...
    menuItems: [
      { name: "Gala Night Burger", description: "A six-ounce Wagyu-blend patty pan-seared in clarified butter until the edges are deeply caramelized, then draped with aged fontina and a crumble of tangy blue cheese. Assembled on a warm black sesame bun with thinly shaved fennel, watercress, a spoonful of bourbon-bacon jam, and a light drizzle of balsamic reduction that ties the rich and savory flavors together beautifully." },
    ],
  },
  {
    name: "Goat Tree",
  ...
  },
  {
    ...
    menuItems: [
      { name: "Little Bird Smash", description: "Three ultra-thin beef patties smashed until crispy and laced together with melted American cheese between each layer, creating a towering stack of savory crunch and gooey goodness. Tucked into a pillowy Martin's potato roll with shredded lettuce, minced white onion, tangy yellow mustard, ketchup, and a secret-recipe burger sauce that keeps regulars coming back week after week." },
    ],
  },
  {
    name: "Pascucci",
    ...
    menuItems: [
      { name: "The Italian Stallion", description: "A hearty beef and Italian sausage blend patty seasoned with fennel and red pepper flakes, griddled until charred at the edges and topped with a generous layer of molten mozzarella and shaved Parmigiano-Reggiano. Served on a garlic-rubbed focaccia with fresh basil leaves, slow-roasted cherry tomatoes, a spoonful of house-made marinara, and a final drizzle of peppery extra-virgin olive oil." },
    ],
  },
  {
    name: "Poke House",
  ...
  },
  {
    ...
    menuItems: [
      { name: "Smokestack Cheddar", description: "A slow-smoked beef brisket patty ground fresh daily and seared on a cast-iron flat-top, layered with two thick slices of smoked cheddar and a heap of tangy vinegar-based coleslaw piled right on top. Served on a toasted jalape\u00f1o-cheddar bun with sweet and smoky barbecue sauce, crispy tobacco onions, dill pickle chips, and a side of creamy ranch for dipping your fries." },
    ],
  },
  {
    name: "SB Biergarten",
  ...
  },
  {
    ...
    menuItems: [
      { name: "Brewmaster Double", description: "Two quarter-pound beef patties stacked tall with a slice of colby jack melted onto each one, sandwiched between layers of thick-cut bacon and crispy beer-battered onion rings dripping with malt vinegar. Pressed onto a toasted egg bun with house-made IPA cheese sauce, shredded romaine, sliced kosher dill pickles, and a tangy hop-infused aioli that ties the whole thing together in hoppy harmony." },
    ],
  },
  {
    ...
    menuItems: [
      { name: "K-Town Cheese Burger", description: "A gochujang-glazed beef patty seared on a hot stone griddle until deeply caramelized, then topped with a melted layer of mild provolone and a fried egg with a runny golden yolk. Served on a steamed milk bun with quick-pickled daikon and carrot, crispy kimchi, a swirl of spicy kewpie mayo, toasted sesame seeds, and thinly sliced scallions for a bold Korean-inspired twist." },
    ],
  },
  {
  ...
  },
  {
    ...
    menuItems: [
      { name: "The Walk-Up Classic", description: "A straightforward quarter-pound all-beef patty griddled until a dark crust forms on both sides, blanketed with a perfectly melted slice of classic yellow American cheese that drapes over the edges. Served on a simple soft white bun with crisp iceberg lettuce, fresh tomato, raw white onion, ketchup, mustard, and a generous stack of crinkle-cut dill pickles for that old-school drive-in cheeseburger feeling." },
    ],
  },
  {
  ...
  },
  {
    ...
    menuItems: [
      { name: "Dave's Dirty Burger", description: "A loose-ground beef patty smashed paper-thin on a screaming griddle so the edges get impossibly crispy and lacy, then loaded with two slices of melty American cheese and a heap of grilled diced onions. Wrapped in a soft steamed bun with yellow mustard, ketchup, chopped dill pickles, and a generous squirt of bright yellow ballpark mustard for a gloriously messy no-frills cheeseburger experience." },
    ],
  },
  {
  ...
  },
  {
    ...
    menuItems: [
      { name: "The Mesa Classic", description: "A grass-fed beef patty cooked to order on a charcoal grill and topped with a perfectly melted slice of Tillamook sharp cheddar that pools into every nook and cranny of the hand-formed burger. Placed on a fresh locally baked brioche bun with organic mixed greens, heirloom tomato, thinly sliced avocado, house-made pickled red onion, and a roasted jalape\u00f1o aioli that brings gentle warmth." },
    ],
  },
  {
    name: "Sama San Roque",
  ...
  },
  {
    ...
    menuItems: [
      { name: "Patio Patty Melt", description: "A seasoned beef patty griddled with a heap of sweet caramelized onions and sandwiched between two slices of buttery grilled rye bread, with both Swiss and American cheese melted together into a gloriously gooey center. Accompanied by a tangy side of house-made Russian dressing for dipping, plus a handful of kettle chips and a crisp half-sour pickle spear to complete the classic diner experience." },
    ],
  },
  {
    ...
    menuItems: [
      { name: "Yellow Belly Smash", description: "Two thin smashed patties of prime beef cooked until the edges are shatteringly crispy, each draped with a slice of muenster cheese that melts into a silky veil over the crackly meat. Stacked on a butter-toasted brioche bun with garlic-confit mayo, quick-pickled red onions, baby spinach, thick-cut heirloom tomato, and a drizzle of hot honey that brings a sweet and fiery finish." },
    ],
  },
  ...
  },
  {
    ...
    menuItems: [
      { name: "Bakery Burger Bun", description: "A juicy beef patty cooked on a flat griddle and nestled inside a freshly baked house-made potato bun that is impossibly soft and lightly sweetened, topped with two slices of melted Monterey Jack cheese. Finished with crispy romaine, thick tomato slices, house-pickled onion rings, a swipe of roasted red pepper aioli, and a side of golden hand-cut fries dusted with garlic salt and herbs." },
    ],
  },
  {
  ...
  // --- Isla Vista ---
  {
    ...
    menuItems: [
      { name: "The Deli Special", description: "A quarter-pound smashed beef patty griddled to order at the deli counter with American cheese melted on top and a fried egg slapped on for good measure, all stacked between a fresh-baked Kaiser roll. Dressed with shredded lettuce, sliced tomato, raw onion, a pile of house-made garlic fries crammed right inside the sandwich, a squirt of Sriracha, and a side of ranch for dipping." },
    ],
  },
